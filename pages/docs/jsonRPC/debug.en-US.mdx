...
References: <a href="https://github.com/ethereum/wiki/wiki/RLP" title="RLP">RLP</a>
...
Similar to <a href="https://Getd.ethereum.org/docs/rpc/ns-debug#debug_traceblock" title="debug_traceBlock">debug_traceBlock</a>,`traceBlockByNumber` accepts a block number and will replay the block that is already present in the database.  
References: <a href="https://github.com/ethereum/wiki/wiki/RLP" title="RLP">RLP</a>

## debug_traceBlockByHash

Similar to <a href="https://Getd.ethereum.org/docs/rpc/ns-debug#debug_traceblock" title="debug_traceBlock">debug_traceBlock</a>,`traceBlockByHash` accepts a block hash and will replay the block that is already present in the database.  
References: <a href="https://github.com/ethereum/wiki/wiki/RLP" title="RLP">RLP</a>

## debug_traceBlockFromFile

Similar to <a href="https://Getd.ethereum.org/docs/rpc/ns-debug#debug_traceblock" title="debug_traceBlock">debug_traceBlock</a>,`traceBlockFromFile` accepts a file containing the RLP of the block.  
References: <a href="https://github.com/ethereum/wiki/wiki/RLP" title="RLP">RLP</a>
...
- `timeout`: `STRING`. Overrides the default timeout of 5 seconds for JavaScript-based tracing calls. Valid values are described <a href="https://pkg.go.dev/time#ParseDuration" title="here">here</a>.
